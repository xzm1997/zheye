<template>
  <nav class="navbar navbar-dark bg-primary justify-content-between mb-4 px-4">
    ...
    <ul v-if="!user.isLogin" class="list-inline mb-0">
      <li class="list-inline-item"><router-link href="#" class="btn btn-outline-light my-2">登陆</router-link></li>
      <li class="list-inline-item"><router-link href="#" class="btn btn-outline-light my-2">注册</router-link></li>
    </ul>
